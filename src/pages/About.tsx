          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="grid grid-cols-3 gap-6">
                  {[
                    ...
                    <div key={stat.label}>
                      <div className="text-2xl sm:text-3xl font-bold text-yellow-500">{stat.number}</div>
              ...
              <div className="relative">
                <div className="absolute -inset-4 bg-yellow-400/20 rounded-3xl blur-xl" />
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div id="vision" className="bg-yellow-400 rounded-2xl p-8 sm:p-10 relative overflow-hidden scroll-mt-32">
                <div className="relative z-10">
                  ...
                  <h3 className="text-2xl sm:text-3xl font-bold text-black mb-4">Our Vision</h3>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={value.title} className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:border-yellow-200 transition-all">
