        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg px-4 py-2 inline-block mb-6">
              ...
              <span className="text-yellow-500 text-sm ml-1">POWERS</span>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            <div>
              ...
              <div className="flex gap-4">
                ...
                <a href="https://play.google.com/store/apps/details?id=in.novapowers.customer&hl=en_IN&pli=1" className="bg-gray-800 hover:bg-gray-700 transition-colors rounded-xl px-4 py-3 flex items-center gap-3" target="_blank" rel="noopener noreferrer">
                  <svg className="w-6 h-6 text-white" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-500">
              &copy; {currentYear} Nova Powers. All rights reserved.
            </p>
